                ...
                <div className="menu-home">  
                    ...
                    <div className="box-aboutme">
                        ...
                        <div className="btn-code">
                            <a href="https://www.linkedin.com/in/bayu-darmawan-09470a1b8/"   className="btn btn-1">
                                <svg>
                                    <rect x="0" y="0" fill="none" width="100%" height="100%"/>
                                </svg>
                                <FaLinkedinIn className="icon-linkedin"/>
                            </a>
                            <a href="https://github.com/gorillaworkout"  target="_blank" className="btn btn-1">
                                <svg>
                                    <rect x="0" y="0" fill="none" width="100%" height="100%"/>
                                </svg>
                                <FiGithub className="icon-linkedin"/>
                            </a>
                            <a href="https://www.instagram.com/gorillaworkout/"  target="_blank" className="btn btn-1">
                                <svg>
                                    <rect x="0" y="0" fill="none" width="100%" height="100%"/>
                                </svg>
                                <AiOutlineInstagram className="icon-linkedin" style={{top:'2px'}}/>
                            </a>
                            <a href="https://www.facebook.com/bayu.darmawan02/"  target="_blank" className="btn btn-1">
                                <svg>
                                    <rect x="0" y="0" fill="none" width="100%" height="100%"/>
                                </svg>
                                <FaFacebookF className="icon-linkedin" style={{top:'2px'}}/>
                            </a>
                            <a href="mailto:darmawanbayu1@gmail.com"  target="_blank" className="btn btn-1">
                                <svg>
                                    <rect x="0" y="0" fill="none" width="100%" height="100%"/>
                                </svg>
